...
export class TurbopackHmr {
   ...
   */ onBuilt() {
        ...
        if (!hasUpdates && !_class_private_field_loose_base(this, _reportedHmrStart)[_reportedHmrStart]) {
        ...
        _class_private_field_loose_base(this, _reportedHmrStart)[_reportedHmrStart] = false;
        return result;
    }
    constructor(){
...
function runDeferredReportHmrStart() {
    if (_class_private_field_loose_base(this, _deferredReportHmrStartId)[_deferredReportHmrStartId] != null) {
        ...
        _class_private_field_loose_base(this, _reportedHmrStart)[_reportedHmrStart] = true;
        _class_private_field_loose_base(this, _cancelDeferredReportHmrStart)[_cancelDeferredReportHmrStart]();
    }
}
